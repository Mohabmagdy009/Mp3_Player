...
public class MainActivity extends AppCompatActivity {
    ...
    // Update progress bar every second with the music played
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Load Music file to player from mobile files
        ...
        //Change mp3 progress by changing seek bar position
    ...
    /*
      Connect main activity to service
      */
